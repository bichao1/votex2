<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="polls.php"><i class="fa fa-tasks"></i> <span>Polls</span></a></li>
      <li class=""><a href="options.php"><i class="fa fa-black-tie"></i> <span>Options</span></a></li>
      <li class="header">SETTINGS</li>
      <li class=""><a href="ballot.php"><i class="fa fa-file-text"></i> <span>Ballot Order</span></a></li>
