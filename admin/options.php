...
<div class="wrapper">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, options.id AS canid FROM options LEFT JOIN polls ON polls.id=options.poll_id ORDER BY polls.priority ASC";
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$row['fname']."</td>
                          <td><a href='#description' data-toggle='modal' class='btn btn-info btn-sm btn-flat description' data-id='".$row['canid']."'><i class='fa fa-search'></i> View</a></td>
                          <td>
  ...
  <?php include 'includes/options_modal.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#posselect').val(response.poll_id).html(response.description);      
      $('#edit_description').val(response.description);
      $('.fullname').html(response.fname);
